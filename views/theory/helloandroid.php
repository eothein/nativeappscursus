...
<article>
    ...
    <p>Android is an open-source software stack that includes the operating system,
        middleware and key mobile applcatons along with a set of API libraries 
    ...
    <div class="all-sections">
        ...
        <?= Html::img('@web/images/android-versions.jpg', ['alt' => 'Android versions', 'width' => '100%', 'class' => "img-responsive"]) ?>
        ...
        <?= Html::img('@web/images/hello/androidstack.jpg', ['alt' => 'Android Stack', 'style' => 'width:960px;height:720px', 'align' => 'middle']) ?>
